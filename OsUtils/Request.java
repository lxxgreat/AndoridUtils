...
public abstract class Request {
    ...
    protected HttpURLConnection getConn() {
        ...
        try {
            ...
            } else if (NetUtils.isWifiConnected(mContext)) {
            ...
            conn.setRequestProperty("User-Agent", Device.getUserAgent(mContext));
            addHeaders(conn);
    ...
    private static String genUrlSign(Map<String, String> paramMap, final String appkey, final String secret) {
        ...
        return CoderUtils.encodeSHA(codes).toUpperCase(Locale.US);
    }

    public static String encryptData(String data) {
       return CoderUtils.base64AesEncode(data, DECODE_KEY);
    }

    public static String decryptData(String data) {
        return CoderUtils.base6AesDecode(data, DECODE_KEY);
    }
}
